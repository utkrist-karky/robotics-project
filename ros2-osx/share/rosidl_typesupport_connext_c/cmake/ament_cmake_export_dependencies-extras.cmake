...
set(_exported_dependencies "rcutils;rmw;rosidl_cmake;rosidl_runtime_c;rosidl_generator_dds_idl;rosidl_typesupport_connext_cpp")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rosidl_typesupport_connext_c_INCLUDE_DIRS "${_include_dirs}")
          endif()
