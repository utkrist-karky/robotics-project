...
set(_exported_dependencies "rcpputils;rcutils;rmw;rmw_connext_shared_cpp;rosidl_runtime_c;rosidl_runtime_cpp;rosidl_typesupport_connext_c;rosidl_typesupport_connext_cpp")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rmw_connext_cpp_INCLUDE_DIRS "${_include_dirs}")
          endif()
