...
#ifndef BoundedSequences_Plugin_1881741019_h
#define BoundedSequences_Plugin_1881741019_h
...
namespace test_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define BoundedSequences_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define BoundedSequences_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define BoundedSequences_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define BoundedSequences_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define BoundedSequences_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern BoundedSequences_*
            ...
            BoundedSequences_PluginSupport_copy_data(
                BoundedSequences_ *out,
                const BoundedSequences_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            BoundedSequences_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                BoundedSequences_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            BoundedSequences_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BoundedSequences_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            BoundedSequences_Plugin_new(void);

            NDDSUSERDllExport extern void
            BoundedSequences_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* BoundedSequences_Plugin_1881741019_h */
