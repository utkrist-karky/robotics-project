...
#ifndef Defaults_Plugin_1627515246_h
#define Defaults_Plugin_1627515246_h
...
namespace test_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define Defaults_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Defaults_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Defaults_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Defaults_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Defaults_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Defaults_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Defaults_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Defaults_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            Defaults_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Defaults_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            Defaults_Plugin_new(void);

            NDDSUSERDllExport extern void
            Defaults_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Defaults_Plugin_1627515246_h */
