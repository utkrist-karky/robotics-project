...
#ifndef BasicTypes_Plugin_132266602_h
#define BasicTypes_Plugin_132266602_h
...
namespace test_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define BasicTypes_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define BasicTypes_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define BasicTypes_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define BasicTypes_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define BasicTypes_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern BasicTypes_Request_*
            ...
            BasicTypes_Request_PluginSupport_copy_data(
                BasicTypes_Request_ *out,
                const BasicTypes_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            BasicTypes_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            BasicTypes_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            BasicTypes_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            BasicTypes_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            BasicTypes_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace test_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define BasicTypes_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define BasicTypes_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define BasicTypes_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define BasicTypes_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define BasicTypes_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern BasicTypes_Response_*
            ...
            BasicTypes_Response_PluginSupport_copy_data(
                BasicTypes_Response_ *out,
                const BasicTypes_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            BasicTypes_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            BasicTypes_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            BasicTypes_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            BasicTypes_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            BasicTypes_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* BasicTypes_Plugin_132266602_h */
