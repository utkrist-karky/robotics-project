...
#ifndef Arrays_Plugin_1007570854_h
#define Arrays_Plugin_1007570854_h
...
namespace test_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define Arrays_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Arrays_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Arrays_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Arrays_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Arrays_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Arrays_Request_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Arrays_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            Arrays_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            Arrays_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            Arrays_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace test_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define Arrays_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Arrays_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Arrays_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Arrays_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Arrays_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Arrays_Response_*
            ...
            Arrays_Response_PluginSupport_copy_data(
                Arrays_Response_ *out,
                const Arrays_Response_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Arrays_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            Arrays_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            Arrays_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            Arrays_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Arrays_Plugin_1007570854_h */
